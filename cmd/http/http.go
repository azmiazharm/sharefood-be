...
func Start(ctx context.Context) {
	...
	defer serve.Done()
	logger.Info(logger.MessageFormat("starting sharefood services... %d", serve.Config().App.Port), logger.EventName(consts.LogEventNameServiceStarting))
